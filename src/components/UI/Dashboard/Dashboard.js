...
function TransactionRow(props){return (
  <button
    className="hover:bg-green-300 w-full"
    onClick={(e) => props.setTransactionModal(true)}
  >
    <div className="">
      <div className="flex my-3 justify-between">
        <div className="grid gap-0.5 grid-cols-2">
          <div className="ml-1.5 rounded-full bg-gray-100 w-11 h-11"></div>
          <div className="grid grid-rows-2 mt-1">
            <div className="font-semibold text-sm">{props.category}</div>
            <div className="text-gray-500 text-xs text-left">{props.note}</div>
          </div>
        </div>
        <div className="text-center grid mr-2 mt-2 font-roboto font-semibold">
         { props.number}
        </div>
      </div>
    </div>
...
function Dashboard() {
    ...
    // map transactions, quando fizer o reques do userefet receber o transactions receber uma lista, com essta 
    // lista de transaction vai criar um row transacions para cada transacions. receber data e o que o dara aceite
    ...
    useEffect(() => {
        WalletService.getWalletOfUser()
            ...
            // TransactionService.getTransaction().then(res => {
                  ...
                  <TabPanel value="2">
                    <div className="grid gap-2">
                      <div className="flex justify-between">
                        <div>Inflow</div>
                        <div className="text-inflow">
                          +{" "}
                          {wallet.currentWallet.balance?.toLocaleString(
                            "en-US",
                            {
                              style: "decimal",
                              currency: "USD",
                      ...
                      <div className="flex justify-between">
                        <div>Outflow</div>
                        <div ref={incomeRef} className="text-rose-600">
                          - 0.00đ
                        </div>
                      </div>
                      <div
                        className="border-t-2 border-gray-300 ml-auto"
                      ...
                      <div className="flex justify-center text-green-400 font-roboto font-semibold">
                    ...
                    <div className="">
                      ...
                      <div className="border border-gray-200">
                        <div className="flex my-3 justify-between">
                          <div className="grid gap-2 grid-cols-2">
                            <div className="text-4xl text-center font-roboto">
                              23
                            </div>
                            <div className="grid grid-rows-2 mt-1">
                      ...
                      <TransactionRow category="Inflow" note="Inflow" number={myNumber} setTransactionModal={setTransactionModal}/>
                    </div>
                  </TabPanel>
                ...
                <div className="shadow-2xl h-fit bg-white w-fit z-30 mt-4 rounded-md">
                  <div className="border-b h-14 bg-white grid grid-cols-2 content-center">
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div>
                        <p className="h-fit mt-1 text-2xl font-roboto ">
                          Transaction Details
                        </p>
                      </div>
                    </div>
                    <div className="grid grid-cols-5">
                      <div></div>
                      <div></div>
                      <button className="text-rose-400 font-roboto font-semibold rounded hover:bg-rose-100">
                        DELETE
                      </button>
                      <button className="text-green-400 font-roboto font-semibold rounded hover:bg-green-100">
                        <Link
