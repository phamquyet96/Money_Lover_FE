        ...
        <div className="flex bg-custom-gray">
          ...
          <div className="w-[100vw] h-[100vh] flex justify-center">
            <div className="shadow-2xl bg-white rounded-md w-[500px] h-[64px] mt-10">
              <div className="border-b rounded-t-md bg-white w-[500px] h-[64px] grid grid-cols-2 gap-2 content-center">
                <div>
                  <p className="text-left w-fit h-fit ml-16 mt-2 text-xl font-semibold font-roboto">
                    My Account
                  </p>
                </div>
                <div className="grid grid-cols-4 items-end">
                  <div></div>
                  <div></div>
                  <button className="text-green-400 font-roboto font-semibold h-[40px] w-[100px] rounded-lg hover:bg-green-100">
                    SIGN OUT
                  </button>
                  <div></div>
                </div>
              ...
              <div className="h-auto shadow-2xl bg-white gap-2 content-center flex-col border-b-2">
                <div className="flex flex-row pt-8 justify-center pb-4 pl-8 ">
                  <div>
                    <div className="w-[60px] h-[60px] rounded-full table-cell align-middle bg-blue-500 text-center text-white text-3xl ">
                      M
                    </div>
                  </div>
